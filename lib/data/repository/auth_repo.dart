...
class AuthRepo {
  ...
  Future<ApiResponse> updateToken() async {
    try {
      ...
      if(ResponsiveHelper.isMobilePhone()) {
        _deviceToken = await (_saveDeviceToken() as FutureOr<String>);
  ...
  Future<String?> _saveDeviceToken() async {
    ...
    if(Platform.isAndroid) {
      _deviceToken = await (FirebaseMessaging.instance.getToken() as FutureOr<String>);
    }else if(Platform.isIOS) {
      _deviceToken = await (FirebaseMessaging.instance.getAPNSToken() as FutureOr<String>);
    }
