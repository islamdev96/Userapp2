                          ...
                          Consumer<SplashProvider>(
                              builder: (context, splashProvider, child) {
                                ...
                                return Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    if(splashProvider.configModel!.socialMediaLink!.length != null && splashProvider.configModel!.socialMediaLink!.length > 0)
                                      Text(
                                        getTranslated('follow_us_on', context)!,
                                        style: poppinsRegular.copyWith(color: ColorResources.getFooterTextColor(context),fontSize: Dimensions.FONT_SIZE_DEFAULT),
                                      ),
                                    Container(height: 50,
