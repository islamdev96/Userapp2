          ...
          ListView(children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if(_timeSlot != null) Row(children: [
                                  ...
                                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                  Text(DateConverter.convertTimeRange(_timeSlot.startTime!, _timeSlot.endTime!, context), style: poppinsMedium),
                                ]),
                                ...
                                Row(children: [
                                  ...
                                  Builder(
                                    builder: (context) => Expanded(flex: 8, child: Row(children: [
                                      (order.trackModel!.paymentMethod != null && order.trackModel!.paymentMethod!.length > 0) && order.trackModel!.paymentMethod == 'cash_on_delivery' ? Text(
            ...
            !order.showCancelled ? Center(
              child: SizedBox(width: 1170, child: Row(children: [
                ...
                (order.trackModel!.paymentStatus == 'unpaid' && order.trackModel!.paymentMethod != 'cash_on_delivery' && order.trackModel!.orderStatus != 'delivered')
                    ? Expanded(child: Container(height: 50, padding: EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_SMALL), child: CustomButton(
                  buttonText: getTranslated('pay_now', context),
                  onPressed: () async {
                    if(ResponsiveHelper.isWeb()) {
                      String? hostname = html.window.location.hostname;
